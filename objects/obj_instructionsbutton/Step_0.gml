...
You must put the string from the export button into ZeroRanger's set_palette() script, using a tool like UndertaleModTool (https://github.com/krzys-h/UndertaleModTool/releases/latest) which I'll be explaining how to use here.
If you know how GML and UndertaleModTool work, You could probably do this on your own manually without reading the rest here. If you don't: Keep reading.
